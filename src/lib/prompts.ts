...
export function lessonWeekPrompt(input: { scope: ScopeSequence; week: number }): string {
  ...
  return [
    ...
    genome ? `FUTURE2 EXPERIENCE GENOME (the instructional-design system for HOW to create exceptional experiential learning — increase experiential practice, autonomy, movement, collaboration, ownership, facilitation quality, engagement, and reflection). It improves HOW students experience the lesson, never WHAT they learn:\n${genome}\n` : ``,
